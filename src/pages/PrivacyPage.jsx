...
export default function PrivacyPage() {
  return (
    <div style={{ backgroundColor: '#F8F5F1', fontFamily: 'sans-serif', color: '#333', padding: '60px 20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <p>Dani Declares LLC operates as a mobile single-source operations firm serving Georgia. We are committed to protecting the data, property photos, and document history submitted through our client and request systems.</p>
      ...
      <p>We use access controls, secure service infrastructure, and operational safeguards appropriate to the information we handle. We do not sell or lease your commercial property data to third-party networks.</p>
