...
export default function ProviderEvidencePage() {
  ...
  return <main className="portal-shell">
    <header className="portal-hero"><div><p className="portal-eyebrow">DANI DECLARES PROVIDER</p><h1>Evidence & Completion</h1><p>Evidence is private and tied to the job/task ledger. Required evidence blocks completion until attached.</p></div><button className="portal-refresh" onClick={load}>Refresh</button></header>
