...
export default function ProviderChecklistPage() {
  const { snapshot, loading, error, message, load, act, uploadEvidence } = useProviderWorkspace();
  ...
  return <main className="portal-shell">
    <header className="portal-hero"><div><p className="portal-eyebrow">DANI DECLARES PROVIDER</p><h1>Field Checklist</h1><p>Required steps for each assigned job.</p></div><button className="portal-refresh" onClick={load}>Refresh</button></header>
