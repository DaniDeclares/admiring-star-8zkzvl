...
export function useProviderWorkspace() {
  ...
  const actionEventName = (action) => ({ assignment_response: 'job_assigned', estimate_assignment_response: 'job_assigned', start_my_job: 'job_started', complete_my_job: 'job_completed', field_event: 'job_started', task_update: 'job_started', change_order_decision: 'estimate_accepted', completion_review: 'job_completed' }[action] || null);
