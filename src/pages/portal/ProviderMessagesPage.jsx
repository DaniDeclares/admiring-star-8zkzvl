...
export default function ProviderMessagesPage() {
  ...
  return <main className="portal-shell">
    <header className="portal-hero"><div><p className="portal-eyebrow">DANI DECLARES PROVIDER</p><h1>Messages</h1><p>Conversation with DANI DECLARES staff and customers, tied to each job you're assigned.</p></div><button className="portal-refresh" onClick={load}>Refresh</button></header>
