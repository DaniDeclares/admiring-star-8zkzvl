...
export default function ProviderAssignmentsPage() {
  ...
  return <main className="portal-shell">
    <header className="portal-hero"><div><p className="portal-eyebrow">DANI DECLARES PROVIDER</p><h1>Assignments</h1><p>Jobs DANI DECLARES dispatches directly to you. Accept or reject each offer — there is no open job board to browse.</p></div><div className="portal-hero-actions"><AccountBadge session={session} /><button className="portal-refresh" onClick={load}>Refresh</button></div></header>
