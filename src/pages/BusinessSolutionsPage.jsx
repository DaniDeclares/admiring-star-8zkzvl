    ...
    <div className="bg-slate-950 text-slate-100 min-h-screen pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-300 text-lg">Current live services are intentionally limited to approved owner-executed work. Broader DANI DECLARES capabilities remain behind PASS 1 underwriting and activation controls.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800">
            <Briefcase className="w-10 h-10 text-amber-400 mb-4" />
            <h3 className="text-2xl font-bold text-white mb-2">Administrative Execution</h3>
            <p className="text-slate-400 text-sm mb-4">Owner-operated support for the work behind the business.</p>
          ...
          <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800">
            ...
            <p className="text-slate-400 text-sm mb-4">When the business needs a person on the ground.</p>
            <ul className="space-y-2 text-sm text-slate-300">
        ...
        <div className="text-center">
          <Link to="/request-service" className="inline-flex items-center px-8 py-4 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-base transition-all">
            Request Business Support <ArrowRight className="ml-2 w-5 h-5" />
          </Link>
        </div>
      </div>
    </div>
