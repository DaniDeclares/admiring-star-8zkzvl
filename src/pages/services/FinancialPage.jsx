  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Financial empowerment services from Dani Declares. Schedule a consultation to discuss your goals."
        />
      </Helmet>
      ...
      <main className="financial-page">
        ...
        <section className="insurance-cta">
          ...
          <p className="disclaimer">No pressure—just real solutions for your goals.</p>
        </section>

        <section className="extra-info">
          <h2>Why Choose Dani Declares?</h2>
          <p>
            We’re not just selling policies. We’re equipping you with tools for generational wealth and peace of mind.
          </p>
        ...
        <ServiceCta link="/contact" bookingLabel="Request a Financial Call" />
      </main>
    </>
  );
}
