...
export default function BusinessSolutionsPage() {
  const businessServices = [
    ...
    },
    {
      ...
      badge: 'Vendor Readiness',
      desc: 'Prepare capability statements, W-9 attachments, Certificate of Insurance (COI) profiles, and vendor application packets. Client-specific requirements remain subject to the requesting organization.'
    },
    {
    ...
    <div className="dd-business-page">
      ...
      <section className="dd-business-hero" style={{ backgroundColor: '#0F050A', color: '#F8F5F1', padding: '60px 20px', textAlign: 'center', borderBottom: '5px solid #C8B273' }}>
        <div style={{ maxWidth: '850px', margin: '0 auto' }}>
          ...
          <Link to="/request-service" style={{ backgroundColor: '#C8B273', color: '#0F050A', padding: '14px 28px', borderRadius: '6px', fontWeight: '800', textDecoration: 'none', display: 'inline-block' }}>
      ...
      <section style={{ padding: '60px 20px', maxWidth: '1100px', margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '50px' }}>
          {businessServices.map((b, i) => (
            <div key={i} style={{ backgroundColor: '#FFFFFF', border: '1px solid #E2D9D0', borderTop: '4px solid #8B1E2E', padding: '28px', borderRadius: '8px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', boxShadow: '0 4px 12px rgba(0,0,0,0.04)' }}>
              ...
              <Link to="/request-service" style={{ backgroundColor: '#8B1E2E', color: '#FFFFFF', padding: '10px 18px', borderRadius: '4px', fontWeight: '700', textDecoration: 'none', textAlign: 'center', fontSize: '14px' }}>
        ...
        <div style={{ backgroundColor: '#FAF8F5', border: '1px solid #C8B273', padding: '30px', borderRadius: '8px', textAlign: 'center' }}>
          ...
          <p style={{ color: '#5A4A52', maxWidth: '700px', margin: '0 auto 20px', fontSize: '15px' }}>
            We help business owners prepare capability statements, W-9 packets, and Certificate of Insurance (COI) profiles for client onboarding, subject to the actual documents and requirements of the requesting organization.
          </p>
          <Link to="/request-service" style={{ backgroundColor: '#8B1E2E', color: '#FFFFFF', padding: '12px 24px', borderRadius: '4px', fontWeight: '700', textDecoration: 'none', display: 'inline-block' }}>
