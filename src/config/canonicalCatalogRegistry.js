...
export const CHANNELS = Object.freeze([
  { id: 'CH01', name: 'Property Residents' },
  { id: 'CH02', name: 'Direct / Regular Residents' },
  { id: 'CH03', name: 'Property Management' },
  { id: 'CH04', name: 'Real Estate' },
  { id: 'CH05', name: 'Business / Commercial' },
  { id: 'CH06', name: 'Government / Institutional' },
]);
...
export const getCatalogEntry = (capabilityId) =>
  COMPANY_WIDE_CATALOG.find((entry) => entry.capabilityId === capabilityId) ?? null;

export const getCatalogByDivision = (divisionId) =>
  COMPANY_WIDE_CATALOG.filter((entry) => entry.divisionId === divisionId);

export const getCommerciallyEligibleCatalog = () =>
  COMPANY_WIDE_CATALOG.filter((entry) => entry.lifecycleState === 'CANONICAL_ACTIVE');
