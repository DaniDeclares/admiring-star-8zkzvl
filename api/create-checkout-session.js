...
export default async function handler(req,res) {
 ...
 try{
  ...
  if(channel==='CH01'&&subchannel&& !['CH01-A','CH01-B'].includes(subchannel)) return json(res,400,{error:'Please select a valid resident subchannel before payment.'});
  ...
  const amount=resolveCommercialPrice({baseServiceId:serviceId,isVerifiedResident:false,hasHeavySoilTier2:false});
