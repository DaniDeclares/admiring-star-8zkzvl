...
export default async function handler(req,res){
 ...
 try{
  const {name,email,phone,category,serviceType,serviceId,pricingServiceId,commercialIntent,details,channelType,organizationName,locationAddress,timeline,budgetRange,requestedStartAt,commercialModel,subchannelCode,requestedTimezone='America/New_York'}=req.body||{};
