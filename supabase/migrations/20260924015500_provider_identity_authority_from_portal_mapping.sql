-- Resolve provider identity from the canonical portal identity map instead of JWT app_metadata.
-- This keeps provider-bound RPCs aligned with dd_portal_identities and avoids requiring duplicated provider_id claims.
