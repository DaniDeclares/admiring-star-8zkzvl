-- CH01 Pass 2/3: canonical service resolution integrity
-- The existing CH01 adjudication register is the authoritative mapping from
-- resident front door + canonical service + resident subchannel.
-- This migration makes that relationship deterministic at the database layer.
