-- Keep the governed offer channel count synchronized with the authoritative
-- service/channel availability ledger. This repairs stale derived counts and
-- prevents future channel authorizations from requiring manual backfills.
