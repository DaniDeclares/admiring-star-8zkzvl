-- Prevent self-service accounts from assigning themselves organization/property/provider scope.
-- Apartment Resident scope is assigned only by the verified invitation consumption function.
