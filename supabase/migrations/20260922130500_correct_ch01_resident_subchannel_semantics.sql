-- Correct the CH01 subchannel semantics established by the original seed migration.
-- CH01-A = regular/direct residents; CH01-B = apartment/property residents enrolled
-- through a participating DANI client property.
-- This migration also corrects the explanatory routing notes.
