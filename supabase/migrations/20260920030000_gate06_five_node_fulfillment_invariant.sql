-- DANI DECLARES Gate 06 five-node fulfillment invariant.
-- Requires required requirements, authorized provider capability, work-order routing,
-- active task template, and at least one active evidence-required task step.
-- DANI DECLARES Service Release Contract v1 gate implementation.
